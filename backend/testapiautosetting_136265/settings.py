"""
Django settings for testapiautosetting_136265 project.
...
ROOT_URLCONF = 'testapiautosetting_136265.urls'
...
WSGI_APPLICATION = 'testapiautosetting_136265.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "TestAPIAutoSettingsz3f1o Support <support@testapiautosetting-136265.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapiautosetting_136265 API",
    "DESCRIPTION": "API documentation for testapiautosetting_136265 App",
    "VERSION": "v1",
}
